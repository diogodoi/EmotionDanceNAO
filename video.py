...
class VideoRecord:
    def __init__(self):
        ...
        self.expressoes = [1,-1]
        arquivo_modelo = 'dcnn_modelo_01_expressoes.h5' # referente aos pesos
        arquivo_modelo_json = 'dcnn_modelo_01_expressoes.json' # referente a arquitetura da Rede Neural
    ...
    def run(self):
        ...
        while self.running:
            ...
            self.score += self.scoreEmotion(frame)
